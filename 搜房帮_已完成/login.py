"""
Base_Url:https://2.fang.com/Product/AgentCloud/wxsfb.html
Author:jing
Modify:2020/10/29
"""
...
class Login(object):
    ...
    def __init__(self, user, pwd):
        ...
        self.sess.headers = {
            ...
            "Referer": "https://2.fang.com/Default.aspx"
        }
        self.login_url = ""
...
setMaxDigits(129);
    ...
    def login_(self):
        pwd = self.get_pwd()
        self.sess.get("https://yun.fang.com/navi/loginjs?v=1.0.6&_=1603950880289")
        print(self.sess.cookies)
        url = "https://passport.fang.com/login.api?callback=myCallBack&Uid={}&Pwd={}&Service=esf-agent-web&IP=&VCode=undefined&AutoLogin=0&_={}".format(
            self.user, pwd, str(int(time.time()*1000))
        )
