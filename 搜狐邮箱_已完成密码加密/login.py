...
class Login(object):
    ...
    def __init__(self, user, pwd):
        ...
        self.login_url = "https://v4.passport.sohu.com/i/login/101305"
    ...
    def login_(self):
        self.sess.get("https://v4.passport.sohu.com/i/cookie/common?callback=passport403_cb1603940903400&_=1603940903648")
        ...
        data = {
            ...
            "password": pwd,
            "appid": "101305",
            "callback": "passport403_cb1603940903890",
